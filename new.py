...
async def convert_to_pdf(input_file, output_file):
    ...
    try:
        ...
        if file_extension == ".html":
            ...
            <head>
                {css}
                <!-- <style>{HtmlFormatter(style='material').get_style_defs('.highlight')}</style> -->
            ...
            # Extract title for header if possible
            title = "Document"
            ...
            extensions = ["fenced_code", "codehilite", "tables", "footnotes", "toc"]
